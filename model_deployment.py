...
# Use session state to manage the state of downloads
if 'downloaded_train' not in st.session_state:
    st.session_state.downloaded_train = False

if 'downloaded_test' not in st.session_state:
    st.session_state.downloaded_test = False

if st.sidebar.button('Download model_train.csv'):
    with open("model_train.csv", "rb") as file:
        ...
        st.session_state.downloaded_train = True

if st.sidebar.button('Download model_test.csv'):
    with open("model_test.csv", "rb") as file:
        st.sidebar.download_button(
        ...
        st.session_state.downloaded_test = True

# Ensure the script does not re-run unnecessarily after file download
if not (st.session_state.downloaded_train or st.session_state.downloaded_test):
    ...
    if uploaded_test_file is not None:
        ...
        corr_matrix = test_data_encoded[selected_features_lasso_0].corr()
